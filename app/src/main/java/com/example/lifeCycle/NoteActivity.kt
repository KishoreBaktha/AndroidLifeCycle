...
import kotlinx.android.synthetic.main.content_main.spinnerCourses
import kotlinx.android.synthetic.main.content_main.textNoteText
import kotlinx.android.synthetic.main.content_main.textNoteTitle

class NoteActivity : AppCompatActivity() {
    private val tag = this::class.simpleName
    private var notePosition = POSITION_NOT_SET

    private var noteGetTogetherHelper = NoteGetTogetherHelper(this, lifecycle)
